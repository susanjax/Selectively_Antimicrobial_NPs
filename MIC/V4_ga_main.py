...
def Genetic_Algorithm(generation_number, population_size):
    ...
    Generation1.to_csv('output/B_sub_vs_a_pleuroneumoniae/pop_size_' + str(population_size) + '_Generation_1.csv')
    ...
    Generation2.to_csv('output/B_sub_vs_a_pleuroneumoniae/pop_size_' + str(population_size)+ '_Generation_2.csv')
    ...
    while g in range(generation_number + 1):
        ...
        Generation_next.to_csv('output/B_sub_vs_a_pleuroneumoniae/pop_size_' + str(population_size) + '_Generation_' + str(g) + '.csv')
        means.append(mean)
        maxs.append(max)
    ...
    summary.to_csv('output/B_sub_vs_a_pleuroneumoniae/summary_pop_size_' + str(population_size) +'_gen_' + str(generation_number)+'.csv')
...
def final_loop():
    ...
    while gen <= 100:
        ...
        et.to_csv('output/B_sub_vs_a_pleuroneumoniae/Time_' + str(population_size) + '.csv')
