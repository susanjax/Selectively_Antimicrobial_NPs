...
Mutation_data = pd.read_csv(r'C:\Users\user\Desktop\Valya\V4_ZOI\output\mutation_rate.csv')
Population_data = pd.read_csv(r'C:\Users\user\Desktop\Valya\V4_ZOI\output\pop.csv')
# print(Population_data.columns)


# Data for population
x = Population_data['generations']
y1 = Population_data['average_max_100']
y2 = Population_data['average_max_50']
y3 = Population_data['average_max_10']
y4 = Population_data['average_mean_100']
y5 = Population_data['average_mean_50']
y6 = Population_data['average_mean_10']
...
plt.savefig('population_ZOI.png', transparent=True)# Show the plot
plt.show()
...
ym1 = Mutation_data['averagemax_0.1p']
ym2 = Mutation_data['averagemax_1p']
ym3 = Mutation_data['averagemax_2p']
ym4 = Mutation_data['averagemax_5p']
ym5 = Mutation_data['averagemax_10p']
y_val = [ym1, ym2, ym3, ym4, ym5]
# Define the logarithmic function to fit
def log_func(xm, a, b, c):
    return a + b*np.log(xm+c)

colors1 = ['purple','orange','green','blue','red']
labels = ['Mutation Rate = 0.1%', 'Mutation Rate = 1%','Mutation Rate = 2%', 'Mutation Rate = 5%', 'Mutation Rate = 10%']
...
plt.savefig('mutation_ZOI.png', transparent=True)
plt.show()
