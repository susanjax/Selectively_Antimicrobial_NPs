...
# Load the data
df1 = pd.read_csv(r'C:\Users\user\Desktop\Valya\V4_ZOI\data\LP\Final_Model_comparision_raw_ZOI.csv')
df2 = pd.read_csv(r'C:\Users\user\Desktop\Valya\V4_ZOI\data\LP\Final_Model_comparision_processed_ZOI.csv')
...
plt.tight_layout()
plt.savefig("top_10_models_r_squared_ZOI.png", dpi=300, transparent=True)
plt.show()
...
# Save the plot
plt.tight_layout()
plt.savefig("top_35_model_comparision_RMSE_ZOI.png", dpi=300, transparent=True)
plt.show()
